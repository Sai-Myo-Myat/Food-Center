    ...
    return (
        <a href={`/detail/${item.id}`}>
            <div className="item p-2 bg-gray-200 rounded">
                <div className="bg-gray-200 w-full h-32 rounded md:mb-5" style={{backgroundImage:`url(${item.image})`,backgroundRepeat: 'no-repeat', backgroundSize: "contain", backgroundPosition: 'center'}}></div>
